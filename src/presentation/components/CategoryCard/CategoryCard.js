    ...
    <View style={styles.mainContainer}>
        <TouchableOpacity onPress={() => onPressCard(nameCategory)}>
            <View style={[styles.iconContainer,
                ...
                <Ionicons color={isSelectedCategory ? "white" : "black"} style={[styles.icon, isSelectedCategory && styles.iconSelected]} size={isSelectedCategory ? 30 : 24} name={iconCategory}></Ionicons>
            </View>
